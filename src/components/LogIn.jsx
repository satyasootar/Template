...
const Login = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-transparent bg-white flex items-center justify-center p-4 transition-colors duration-300">
      <div className="relative w-full max-w-md dark:bg-black bg-white dark:bg-opacity-90 bg-opacity-90 rounded-xl shadow-2xl px-8 py-10 sm:px-10 sm:py-12 transition-colors duration-300">
        <div className="flex justify-center items-center mb-8">
          <p className="dark:text-white text-gray-900 text-2xl font-bold">Login</p>
